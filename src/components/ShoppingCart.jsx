    ...
    return (
        <>
            ...
            <div className="fixed inset-0 z-50">
                ...
                {/* Cart Modal */}
                <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 border-2 w-[90%] md:w-[80%] lg:w-[70%] xl:w-[60%] bg-white shadow-xl rounded-lg z-50 overflow-y-auto ">
