...
const Footer = () => {
  ...
  return (
    <footer className="bg-black text-white">
      {/* Main Footer Content */}
      <div className="max-container py-12 sm:py-16">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 sm:gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            <a href="/" className="inline-block mb-4 sm:mb-6">
              <img
                ...
                height={46}
                alt="Nike Logo"
                className="hover:opacity-80 transition-opacity w-32 sm:w-36 md:w-40 lg:w-[150px]"
              />
            </a>

            <p className="font-montserrat text-sm sm:text-base leading-6 sm:leading-7 text-white-400 mb-4 sm:mb-6 max-w-sm">
              Get shoes ready for the new term at your nearest Nike store. Find
              Your perfect Size In Store. Get Rewards
            </p>
            ...
            <div className="mb-6 sm:mb-8">
              <h4 className="font-montserrat text-base sm:text-lg font-medium mb-3 sm:mb-4 text-white">
                Follow Us
              </h4>
              <div className="flex gap-3 sm:gap-4">
                {socialMedia.map((icon, index) => (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="bg-white rounded-full flex justify-center items-center w-10 h-10 sm:w-12 sm:h-12 cursor-pointer hover:bg-coral-red hover:scale-110 transition-all duration-300 group"
                    aria-label={icon.alt}
                  >
                    <img
                      src={icon.src}
          ...
          <div className="lg:col-span-3">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              {footerLinks.map((section, index) => (
                <div key={index}>
                  <h4 className="font-montserrat text-lg sm:text-xl leading-normal font-medium mb-4 sm:mb-6 text-white">
                    {section.title}
                  </h4>
                  <ul className="space-y-2 sm:space-y-3">
                    {section.links.map((link, linkIndex) => (
                      <li key={linkIndex}>
                        <a
                          href={link.link}
                          className="text-white-400 font-montserrat text-sm sm:text-base leading-normal hover:text-white hover:translate-x-1 transition-all duration-200 inline-block"
                        >
                          {link.name}
                        </a>
                      </li>
        ...
        <div className="mt-12 sm:mt-16 pt-6 sm:pt-8 border-t border-gray-800">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 text-center md:text-left">
            ...
            {/* Contact Info */}
            <div>
              <h5 className="font-montserrat font-medium mb-2 sm:mb-3 text-white text-sm sm:text-base">Contact Us</h5>
              <div className="space-y-1 sm:space-y-2 text-white-400 text-xs sm:text-sm">
                <p>📞 1-800-NIKE-123</p>
                <p>✉️ support@nike.com</p>
                <p>📍 One Bowerman Drive, Beaverton, OR</p>
              </div>
            ...
            {/* Quick Stats */}
            <div>
              <h5 className="font-montserrat font-medium mb-2 sm:mb-3 text-white text-sm sm:text-base">Why Choose Nike</h5>
              <div className="space-y-1 sm:space-y-2 text-white-400 text-xs sm:text-sm">
                <p>✓ Free shipping on orders $50+</p>
                <p>✓ 30-day return policy</p>
                <p>✓ Exclusive member benefits</p>
            ...
            <div className="flex flex-col items-center md:items-end sm:hidden hidden md:block">
              <button
                onClick={scrollToTop}
                className="bg-coral-red text-white p-2.5 sm:p-3 rounded-full hover:bg-coral-red/90 hover:scale-110 transition-all duration-300 mb-3 sm:mb-4"
                aria-label="Back to top"
              >
              ...
              <p className="text-white-400 text-xs sm:text-sm">Back to top</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Bottom Bar */}
      <div className="border-t border-gray-800">
        <div className="max-container padding-x py-4 sm:py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-3 sm:gap-4">

            {/* Copyright */}
            <div className="flex items-center text-white-400 font-montserrat text-xs sm:text-sm">
              <img
                src={copyrightSign}
                width={20}
                height={20}
                className="rounded-full mr-2 w-4 h-4 sm:w-5 sm:h-5"
                alt="Copyright"
              />
              <span>2024 Nike, Inc. All rights reserved.</span>
            </div>
            ...
            {/* Payment Methods */}
            <div className="flex items-center gap-2">
              <span className="text-white-400 text-xs sm:text-sm mr-1 sm:mr-2">We accept:</span>
              <div className="flex gap-1 sm:gap-2">
                {['💳', '💰', '🏦', '📱'].map((icon, index) => (
                  <div key={index} className="w-6 h-6 sm:w-8 sm:h-8 bg-gray-800 rounded flex items-center justify-center text-xs sm:text-sm">
                    {icon}
                  </div>
                ))}
              </div>
      ...
      <div className="md:hidden fixed bottom-4 right-4 z-50">
        <button
          onClick={scrollToTop}
          className="bg-coral-red text-white p-3 sm:p-4 rounded-full shadow-lg hover:bg-coral-red/90 hover:scale-110 transition-all duration-300"
          aria-label="Back to top"
        >
